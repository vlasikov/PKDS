...
//			}
		...
		case MS_CLOSED:
		{
			...
			//WriteClutch(CLUTCH_LOCK);
//
//			if(fallen_edge && fail_counter < 1)
//			{
//				if(!(wait_timer%40))
//				{
//					fallen_edge--;
//					MotorSetPILimit(fallen_edge);
//				}
//			}
//
//			if(wait_timer >= 200 && fail_counter < 1)
//			{
//				MotorStop();
//			}
//			if(wait_timer >= 300 && fail_counter < 1)
//			{
//				MotorStop();
//
//				if((drive.Position >= 10) && (fail_counter < 1))
//				{
//					MainState = MS_HOMING;
//					wait_timer = 0;
//					fail_counter++;
...
//
//				if(/*(wait_timer >= 1000) ||*/ PassengerButton || DisabledButton|| ServiceButton)
//				{
//					wait_timer = 0;
//					MainState = MS_CLOSING;
//					CloseTime = 0;
