...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAN_NODE" URI="http://resources/4.1.24/app/CAN_NODE/0" description="The CAN_NODE APP configures a node and MO registers &#xA;of MultiCAN module. &#xA;It provides run-time functions to change the node baud rate &#xA;and to enable/disable node and MO events." mode="NOTSHARABLE" version="4.1.24" minDaveVersion="4.0.0" instanceLabel="CAN_EXT" appLabel="">
  ...
  <virtualSignals name="event_node_frame_count" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_can_cfcinp" hwSignal="cfcinp" hwResource="//@hwResources.2" visible="true"/>
  ...
  <virtualSignals name="event_lmo_01_rxinp" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_message1_rxinp" hwSignal="rxinp" hwResource="//@hwResources.3" visible="true"/>
  ...
  <virtualSignals name="event_lmo_04_rxinp" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_message4_rxinp" hwSignal="rxinp" hwResource="//@hwResources.6" visible="true"/>
  ...
  <virtualSignals name="event_lmo_05_rxinp" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_message5_rxinp" hwSignal="rxinp" hwResource="//@hwResources.7" visible="true"/>
  ...
  <virtualSignals name="event_lmo_08_rxinp" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_message8_rxinp" hwSignal="rxinp" hwResource="//@hwResources.10" visible="true"/>
  ...
  <hwResources name="CAN Receive Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_rx" resourceGroupUri="devicepackage/0/114" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.13"/>
  </hwResources>
  <hwResources name="CAN Transmit Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_tx" resourceGroupUri="devicepackage/0/113" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message1_rxinp/http://resources/4.0.10/app/INTERRUPT/0/vs_nvic_signal_in" sourceSignal="event_lmo_01_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.9">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message4_rxinp/http://resources/4.0.10/app/INTERRUPT/6/vs_nvic_signal_in" sourceSignal="event_lmo_04_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.15">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../INTERRUPT/v4_0_10/INTERRUPT_6.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../INTERRUPT/v4_0_10/INTERRUPT_6.app#//@virtualSignals.0"/>
  </connections>
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message5_rxinp/http://resources/4.0.10/app/INTERRUPT/4/vs_nvic_signal_in" sourceSignal="event_lmo_05_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.17">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_can_alinp/http://resources/4.0.10/app/INTERRUPT/7/vs_nvic_signal_in" sourceSignal="event_node_alert" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.4">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../INTERRUPT/v4_0_10/INTERRUPT_7.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../INTERRUPT/v4_0_10/INTERRUPT_7.app#//@virtualSignals.0"/>
  </connections>
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_can_cfcinp/http://resources/4.0.10/app/INTERRUPT/7/vs_nvic_signal_in" sourceSignal="event_node_frame_count" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../INTERRUPT/v4_0_10/INTERRUPT_7.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../INTERRUPT/v4_0_10/INTERRUPT_7.app#//@virtualSignals.0"/>
  </connections>
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message8_rxinp/http://resources/4.0.10/app/INTERRUPT/3/vs_nvic_signal_in" sourceSignal="event_lmo_08_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.23">
